...
Describe "SoftwareDetection Module Tests" {
    BeforeAll {
        ...
        } -ModuleName SoftwareDetection -ParameterFilter { $Path -like "*Desktop*" -or $Path -like "*Start Menu\Programs*" }
        ...
        # Mock pour Remove-DuplicateSoftware pour gérer les cas vides
